    ...
    <div class="ml-auto mr-auto w-25 text-center mb-4 ">
      <nav class="container-fluid w-25 pl-0 mt-3">
        <ul class="pagination">
          ...
          <li class="page-item">
            <button class="btn btn-outline-secondary" disabled>{{ pagination }}</button>
          </li>
          <li class="page-item">
      ...
      <ul v-for="recette in recettes" class="list-group-item" id="liste">
        <li class="media list-group-item-light flex-xl-row flex-lg-row flex-md-row flex-sm-column">
          ...
          <div class="flex-column">
            ...
            <router-link :to="{ path : '/display/'+ recette.rid }" tag="button" class="btn btn-outline-secondary">
              Consulter
            </router-link>
            <button class="btn btn-outline-secondary" @click="attributeRid(recette.rid)" data-toggle="modal"
                    data-target="#exampleModal">Noter
            </button>
          </div>
        </li>
      </ul>
