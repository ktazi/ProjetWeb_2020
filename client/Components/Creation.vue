<template>
  <div id="main">
    <div>
        ...
        <div v-if="display_title">
          <div class="row justify-content-center">
            ...
            <button @click="title" class="btn">
              <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-pencil" fill="cyan"
      ...
      <div class="row justify-content-center pt-2 text-light pt-3 pb-3"
           style="background:linear-gradient(90deg, rgba(66,72,116,1) 0%, rgba(166,177,225,1) 79%, rgba(220,214,247,1) 100%) ">
        <h2>Tags : </h2>
        <div v-if="display_tag" class="row justify-content-center pt-2 ">
          ...
          <button @click="tag" class="btn">
            <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-pencil" fill="white"
                 xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
                    d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
            </svg>
        ...
        <div v-else class="row justify-content-center pt-2 ">
          <ul v-for="(tag,index) in recipe.tag" style="list-style: none; padding-left: 0.5vw">
            <li class="ml-2">
              <div class="input-group"><input type="text" class="form-control" :value="tag" :id="'tag'+index">
                <button class="btn input-group-append btn-secondary" @click="rem_tag(index)">-</button>
              </div>
            </li>
          </ul>
          ...
          <div class="mb-5">
            ...
            <div v-else>
              <ul v-for="(ing,index) in recipe.ing" style="list-style: none; padding-left: 0.5vw">
                <li>
                  <div class="input-group"><input type="text" class="form-control" :value="ing" :id="'ing'+index">
                    <button class="btn input-group-append btn-secondary" @click="rem_ing(index)">-</button>
                  </div>
                </li>
              </ul>
          ...
          <div class="text-light">
            ...
            <div v-else>
              <ul v-for="(mat,index) in recipe.mat" style="list-style: none; padding-left: 0.5vw">
                <li>
                  <div class="input-group"><input type="text" class="form-control" :value="mat" :id="'mat'+index">
                    <button class="btn input-group-append btn-secondary" @click="remMat(index)">-</button>
                  </div>
                </li>
              </ul>
        ...
        <div class="col-9  border-right pt-5 pb-5 pl-5 pr-5 text-dark bg-light" style="background-color: #424874">
          ...
          <div v-if="display_steps">
            ...
            <button @click="steps" class="btn">
              <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-pencil" fill="black"
                   xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                      d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5L13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175l-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
              </svg>
          ...
          <div v-else>
            <ul v-for="(steps,index) in recipe.steps" style="list-style: none; padding-left: 0.5vw">
              <li>
                <div class="input-group"><textarea type="text" class="form-control" :value="steps"
                                                   :id="'step'+index"></textarea>
                  <button class="btn input-group-append btn-secondary" @click="remStep(index)">-</button>
                </div>
              </li>
            </ul>
          ...
          <div class="text-right">
            <button class="button btn-outline-secondary mb-5 mr-5 rounded-pill pl-2 pt-2 pr-2 pb-2"
                    @click="submit_recipe">
              <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-check2" fill="currentColor"
                   xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
